...
function(fetch_freetype_gl)
	...
	# # manual target build set(FREETYPE_GL_SRC texture-atlas.c texture-font.c
	# distance-field.c platform.c utf8-utils.c vector.c edtaa3func.c )
	# set(FREETYPE_GL_HDR texture-atlas.h texture-font.h distance-field.h
	# platform.h utf8-utils.h vector.h edtaa3func.h ) set(FREETYPE_GL_FILES )
	# foreach(F ${FREETYPE_GL_SRC}) list(APPEND FREETYPE_GL_FILES
	# ${freetype-gl_SOURCE_DIR}/${F}) endforeach(F ${FREETYPE_GL_SRC}) foreach(F
	# ${FREETYPE_GL_HDR}) list(APPEND FREETYPE_GL_FILES
	# ${freetype-gl_SOURCE_DIR}/${F}) endforeach(F ${FREETYPE_GL_HDR})
	# add_library(freetype-gl STATIC ${FREETYPE_GL_FILES})
	set(FREETYPE_GL_INCLUDE_DIRS
		${freetype-gl_SOURCE_DIR} ${freetype-gl_BINARY_DIR}
		PARENT_SCOPE
	)
